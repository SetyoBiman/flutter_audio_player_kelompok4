import 'package:flutter_audio_player_kelompok4/utils/utils.dart';
import 'package:flutter_audio_player_kelompok4/widgets/audio_info.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future initPlayer() async {
    player = AudioPlayer();
    path = AssetSource('audios/vvv.mp3');
